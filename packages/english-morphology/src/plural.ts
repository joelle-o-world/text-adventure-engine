...
export const regularPluralisation = {
  singular: {
    ...
    plural(singular: string) {
      ...
      if (/us$/.test(singular)) return singular.slice(0, -1) + "i";
      ...
      if (/on$/.test(singular)) return singular.slice(0, -2) + "a";
