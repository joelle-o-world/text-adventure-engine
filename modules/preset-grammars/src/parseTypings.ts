...
export function isArticleParse(o: any): o is ArticleParse {
  return typeof o === "string" && /the|a|an|some|any/.test(o);
}
...
export function assertIsArticleParse(o: any): o is ArticleParse {
  if (isArticleParse(o)) return true;
  else throw "Article parse is invalid: " + o;
}
...
export function assertIsAdjectiveParse(o: any): o is AdjectiveParse {
  if (isAdjectiveParse(o)) return true;
  else throw "Adjective parse is invalid: " + o;
}
...
export function assertIsNounParse(o: any): o is NounParse {
  if (isNounParse(o)) return true;
  else throw `Noun parse is invalid: ${o}`;
}
...
export function assertIsSimpleNounPhraseParse(
  o: any
): o is SimpleNounPhraseParse {
  if (typeof o !== "object")
  ...
  for (let adj of o.adjectives) assertIsAdjectiveParse(adj);
...
export function assertIsPronounParse(o: any): o is PronounParse {
  ...
  for (let field of [
    ...
    if (typeof o[field] != "boolean")
      throw `PronounParse.${field} must be a boolean, recieved: ${typeof o[
        field
      ]}`;
...
export function assertIsNounPhraseParse(o: any): o is NounPhraseParse {
  ...
  else if (o.kind == "pronoun") return assertIsPronounParse(o);
  else if (o.kind == "simpleNounPhrase")
    return assertIsSimpleNounPhraseParse(o);
  else
    throw (
      "NounPhraseParse must be either SimpleNounPhraseParse or PronounParse, recieved: " +
      JSON.stringify(o)
    );
}
...
export function assertIsPredicateSyntaxParse(
  o: any
): o is PredicateSyntaxParse {
  if (typeof o != "object")
